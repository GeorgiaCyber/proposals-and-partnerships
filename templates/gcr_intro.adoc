The Georgia Cyber Range is a computing environment hosted at the Georgia Cyber Center meant to provide a platform for education, training, research, demonstrations, development and more.
