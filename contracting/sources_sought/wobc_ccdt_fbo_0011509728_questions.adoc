...
. Is the Government open to suggestions from offerers on how to improve the student experience, via alternate delivery methods, content improvements/adjustments, changes to instructor qualifications, and other related items?
