...
In collaboration with the Fort Gordon SFL-Tap, under the Career Skill Program, the Workforce Academy developed different tracks for transitioning service members to develop, enhance, and acquire skills in the cybersecurity industry. With any chosen track, service members will received customized, top-of-the line, industry training that leads to certifications along with industry field exposure to widen future career opportunity.
